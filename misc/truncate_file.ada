--
-- The following program is an implementation in Ada using system-independent 
-- tools from the standard library to read and write files, remove and rename them. 
-- It should work for on any system with byte-oriented file storage and uses 
